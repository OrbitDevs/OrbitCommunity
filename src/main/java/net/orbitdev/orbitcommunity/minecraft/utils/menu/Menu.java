...
public abstract class Menu {
    ...
    private Button placeholderButton = Button.placeholder(Material.valueOf(OrbitCommunity.get().getSettingsConfig().getString("BUTTONS.FILLER.MATERIAL")), OrbitCommunity.get().getSettingsConfig().getInt("BUTTONS.FILLER.DATA"), OrbitCommunity.get().getSettingsConfig().getString("BUTTONS.FILLER.NAME"), OrbitCommunity.get().getSettingsConfig().getBoolean("BUTTONS.FILLER.GLOW"));
